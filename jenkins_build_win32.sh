...
STRIP="$TARGET-strip"
CFLAGS="-D_WIN32_WINNT=0x501 -DWINVER=0x501"
...
CFLAGS=$CFLAGS $MAKE_CMD CC=$CC AS=$AS RANLIB=$RANLIB AR=$AR WINDRES=$WINDRES STRIP=$STRIP DEBUG=$DEBUG -f Makefile.w32 USE_SDL2=$SDL2 USE_ZLIB=0 $*
makestatus=$?
